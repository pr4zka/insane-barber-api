...
const barbers_repository_1 = require("./barbers.repository");
...
exports.BarbersModule = BarbersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [barbers_service_1.BarbersService, barbers_repository_1.BarbersRepository, prisma_service_1.PrismaService],
